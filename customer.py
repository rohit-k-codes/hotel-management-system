...
from tkinter import ttk #stylish entity
import random #ref no
...
class Cust_Win:
    def __init__(self,root):
        ...
        combo_id["value"]=("Adhar card","Driving License","Passport")
        combo_id.current(0)
        ...
        details_table.place(x=0,y=50,width=860,height=450)
    ...
    def mDelete(self):
        ...
        if mDelete>0:
            ...
            my_cursor=conn.cursor()
            #another method to execute query in python
